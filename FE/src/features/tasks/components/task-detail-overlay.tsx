...
export function TaskDetailDrawer({
  ...
  return createPortal(
    ...
    >
      ...
      <div
        className={cn(
          "relative flex w-full flex-col bg-card text-card-foreground shadow-xl",
...
export function TaskDetailModal({
  ...
  return createPortal(
    ...
    >
      ...
      />
      <div
        className="relative flex max-h-[min(92vh,100dvh)] w-full max-w-3xl flex-col rounded-t-2xl border border-border bg-card text-card-foreground shadow-xl sm:max-h-[min(85vh,720px)] sm:rounded-2xl dark:border-slate-800"
        role="dialog"
        aria-modal="true"
      >
